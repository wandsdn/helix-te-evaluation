...
plot 'ConLoss/Abilene_3.0/0.dat' using 2:3 title 'CSPF' w lp ls 1 lw 4 pt 0, \
    'ConLoss/Abilene_3.0/1.dat' using 2:3 title 'MCF' w lp ls 2 lw 4 pt 0 dt (4,1,4,1) , \
    'ConLoss/Abilene_3.0/2.dat' using 2:3 title 'Helix' w lp ls 7 lw 4 pt 0 dt (6,3,2,3)
...
#set xtics 20 offset 0,0.5 nomirror
set xtics 0,20,60 offset 0,0.5 nomirror
set xtics add ("80" 80 0)
set xtics add ("100  " 100 0)
set ytics 0.2 offset 0.5,0 nomirror

plot 'PathChurn/Abilene_3.0/0.dat' using 2:3 title 'CSPF' w lp ls 1 lw 4 pt 0, \
    'PathChurn/Abilene_3.0/1.dat' using 2:3 title 'MCF' w lp ls 2 lw 4 pt 0 dt (4,1,4,1), \
    'PathChurn/Abilene_3.0/2.dat' using 2:3 title 'Helix' w lp ls 7 lw 4 pt 0 dt (6,3,2,3)
